...
class Customer {
    constructor(logger) {
        ...
        this.onFinish = () => this.log(`Stopping simulation of ${this.firstName} ${this.lastName}`);
    ...
    simulate() {
        ...
        this.doSimulation(this.onFinish);
    }
}
...
class WarehouseWorker {
    constructor(logger) {
        ...
        this.onFinish = () => {
            this.log(`Restarting simulation of ${this.firstName} ${this.lastName}`);
            this.enqueueNextCycle();
            this.simulate();
        };
    }
